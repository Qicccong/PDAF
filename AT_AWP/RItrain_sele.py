...
def main():
    ...
    parser.add_argument('--epochs', default=20   # 多少个epoch检测一次模型最脆弱层次
    ...
    parser.add_argument('--proj_name', default=f"FTS_robust_{parser.parse_args().model}_80_1", type=str, help='model used')
    ...
    for  rounds_1 in range(1):
        ...
        for epoch in range(start_epoch, start_epoch + args.epochs):
            ...
            # else:
            #     if epoch % 2 == 0:
            #         params = "{}epoch{}_params.pth".format(rounds_1,epoch)
        ...
        logger.info("==> Finetune hits10: {:.4f}%, robust hit10: {:.4f}".format(hr10, test_robust_hit10))
