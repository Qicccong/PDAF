...
ARG_COMBINATIONS = [
    ...
    # ["--lr", "0.05", "--awp-gamma", "0.005", "--dataset", "AMusic", "--epochs", "5", "--model_path", "AT_AWP/param_file/RAWP/11_AMusic_MLP_init_1714030591.7578497.pth"],
    # ["--lr", "0.2", "--awp-gamma", "0.005", "--dataset", "AMusic", "--epochs", "5", "--model_path", "AT_AWP/param_file/RAWP/11_AMusic_MLP_init_1714030591.7578497.pth"],
    ...
    # ["--lr", "0.05", "--awp-gamma", "0.005", "--dataset", "AMusic", "--epochs", "10", "--model_path", "AT_AWP/param_file/RAWP/11_AMusic_MLP_init_1714030591.7578497.pth"],
    ["--lr", "0.05", "--awp-gamma", "0.005", "--dataset", "AMusic", "--epochs", "10", "--model_path", "AT_AWP/param_file/RAWP/11_AMusic_MLP_init_1714030591.7578497.pth"],
    ["--lr", "0.02", "--awp-gamma", "0.005", "--dataset", "AMusic", "--epochs", "10", "--model_path", "AT_AWP/param_file/RAWP/11_AMusic_MLP_init_1714030591.7578497.pth"],
