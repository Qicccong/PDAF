...
def main():
    ...
    model_path2 = '30_1_RAT_ml-1m_0.0005_fgsm_MLP_robust.pth'
    # model_path3 = '27_1_7020_ml-1m_MLP_adv_1709823057.6422696.pth'
    # model_path4 = '26_ml-1m_MLP_adv_RAWP6950_5067.pth'
    # model_path5 = '43_ml1m_RAWP_ml-1m_MLP_adv_1710309496.812673.pth'
    # model_path6 = '33_ml-1m_MLP_adv_1709919636.347698.pth'
    # model_path7 = '49_clean_ml-1m_MLP_1711099416.727387.pth'
    model_path8 = 'pretrained/66_ml-1m_MLP_init_1711925571.4551265.pth'
    print(model_path1)
    print(model_path2)
    # print(model_path3)
    # print(model_path4)
    # model_paths = [model_path1, model_path2, model_path3,model_path4,model_path5,model_path6,model_path7,model_path8]
    # model_paths = [ model_path2,model_path4,model_path6,model_path7,model_path8]
    model_paths = [ model_path1,model_path2,model_path8]
    # model_labels = ['clean_29', 'RAT_28_mim', '27_1RAWP','26RAWP','43RAWP','clean_33','clean_49','46RAWP']
    model_labels = [ 'clean_29', 'RAT_30_1','66RAWP']
    losses_avg = np.zeros((len(model_paths), 2*steps+1))
    loss_functions = [adjust_and_record_loss, 
                      adjust_and_record_loss,
                      adjust_and_record_loss_RAWP]
    # loss_functions = [adjust_and_record_loss, 
    #                   adjust_and_record_loss, 
    #                   adjust_and_record_loss_RAWP,
    #                   adjust_and_record_loss_RAWP,
