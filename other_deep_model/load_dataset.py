...
class Load_Yelp():
    ...
    def load_rating(self, path):
        ...
        # if item_count <= n_value:
        #     item_count = n_value+1
    ...
    def load_test_negative(self):
        ...
        # 这两个json存的是lastfm的数据，AMusic和ml-1m用不了
        neg = {}
        ...
        print(f"DUBUG: user_count: {user_count}, test_rating:{len(self.test_rating)}")
        for u in range(user_count):
