...
ARG_COMBINATIONS = [
    ...
    ["--lr", "0.001", "--awp-gamma", "0.001", "--data_set", "ml-1m", "--model_path", "AT_AWP/param_file/other_model/NeuMF/ml-1m/ml-1m_lr-0.001_NeuMF_6790.pth"], 
    ["--lr", "0.0001", "--awp-gamma", "0.001", "--data_set", "ml-1m", "--model_path", "AT_AWP/param_file/other_model/NeuMF/ml-1m/ml-1m_lr-0.001_NeuMF_6790.pth"],
