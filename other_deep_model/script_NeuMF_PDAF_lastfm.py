...
ARG_COMBINATIONS = [
    ...
    ["--lr", "0.01", "--awp-gamma", "0.008", "--data_set", "lastfm", "--model_path", "AT_AWP/param_file/other_model/NeuMF/lastfm/lastfm_lr-0.0005_g-0.005_NeuMF_RAWP_8771.pth"], 
    # ["--lr", "0.0001", "--awp-gamma", "0.005", "--data_set", "lastfm", "--model_path", "AT_AWP/param_file/other_model/NeuMF/lastfm/lastfm_lr-0.001_g-0.005_NeuMF_RAWP.pth"],
    ["--lr", "0.1", "--awp-gamma", "0.008", "--data_set", "lastfm", "--model_path", "AT_AWP/param_file/other_model/NeuMF/lastfm/lastfm_lr-0.0005_g-0.005_NeuMF_RAWP_8771.pth"],
    ["--lr", "0.001", "--awp-gamma", "0.008", "--data_set", "lastfm", "--model_path", "AT_AWP/param_file/other_model/NeuMF/lastfm/lastfm_lr-0.0005_g-0.005_NeuMF_RAWP_8771.pth"],
]
