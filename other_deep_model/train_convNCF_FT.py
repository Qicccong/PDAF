...
if __name__=="__main__":
    ...
    advHR10=[]
    advNDCG10=[]
    save_dir = f'pretrain/ConvNCF_RAWP-FT/{args.data_set}_{args.lr}_{args.awp_gamma}/'
    for path in [save_dir]:
        if not os.path.isdir(path):
            os.makedirs(path)
    logger = create_logger(save_dir+'ConvNCF_FT_output.log')
    logger.info(args)
    args.logger = logger
    ...
    for rounds_1 in range(1):
        ...
        robust_HR10 = evaluate_adv.evalulate_robustness(args, model, args.trainloader, args.optimizer, args.epsilon, testRatings, testNegatives, 10, 20, 50, 100)
        ...
        for epoch in range(20):
            ...
            modelPath = save_dir + f"{args.data_set}_lr-{args.lr}_g-{args.awp_gamma}_ConvNCF_FT.pth"
