...
ARG_COMBINATIONS = [
    ...
    ## RWAP-FT
    ["--data_set", "AMusic", "--lr", "0.01", "--model_path", "AT_AWP/param_file/other_model/ConvNCF/AMusic/AMusic_lr-0.002_g-0.005_PDAF_3418.pth"],
    ["--data_set", "AMusic", "--lr", "0.1", "--model_path", "AT_AWP/param_file/other_model/ConvNCF/AMusic/AMusic_lr-0.002_g-0.005_PDAF_3418.pth"],
