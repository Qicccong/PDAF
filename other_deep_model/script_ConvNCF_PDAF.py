...
ARG_COMBINATIONS = [
    ...
    ## RWAP-FT
    # ["--data_set", "ml-1m", "--lr", "0.01", "--model_path", "AT_AWP/param_file/other_model/ConvNCF/ml1m_ConNCF_RAWP.pth"],
    
    ["--data_set", "lastfm", "--lr", "0.01", "--model_path", "AT_AWP/param_file/other_model/ConvNCF/lastfm_ConNCF_RAWP.pth"],
]
