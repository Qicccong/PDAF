...
ARG_COMBINATIONS = [
    ...
    ## RWAP-FT
    ["--data_set", "ml-1m", "--lr", "0.01", "--model_path", "AT_AWP/param_file/other_model/ConvNCF/ML-1M/ml1m_lr-0.01_g-0.005_ConvNCF_6421.pth"],
    ["--data_set", "ml-1m", "--lr", "0.001", "--model_path", "AT_AWP/param_file/other_model/ConvNCF/ML-1M/ml1m_lr-0.01_g-0.005_ConvNCF_6421.pth"],
]
